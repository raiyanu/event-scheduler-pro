...
import { Button, ButtonGroup, Link, TextField, ThemeProvider, Typography } from "@mui/material";
    ...
    return (
        <ThemeProvider theme={Theme}>
            <Box className="flex h-screen w-screen items-center justify-start bg-[url(/bg-frame.svg)] bg-cover bg-center bg-no-repeat text-black dark:text-white">
                <Box sx={{ width: "300px", marginInline: "auto", height: "500px" }} className="rounded-md bg-white p-4 shadow-2xl">
