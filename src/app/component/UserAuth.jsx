...
import { Button, ButtonGroup, Link, TextField, Typography } from "@mui/material";
...
export function Auth() {
    ...
    return (
        <Box className="flex h-screen w-screen items-center justify-start bg-[url(/bg-frame.svg)] bg-cover bg-center bg-no-repeat text-black dark:text-white">
            <Box sx={{ width: "300px", marginInline: "auto", height: "500px" }} className="rounded-lg bg-white p-4 shadow-2xl">
                <Box>
                    <Tabs
                        value={value}
...
export function Login() {
    return (
        <Box className="flex flex-col gap-4">
            ...
            <Typography variant="subtitle1" color="textSecondary" className="mx-auto">or</Typography>
            <Box
                sx={{
                    display: 'flex',
                    alignItems: 'center',
